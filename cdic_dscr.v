...
Module description.
Structure type (Q: Type) := Pack {
A:> Type;
fuel: countType;
zero: fuel;
}.
End description.
Coercion description.A: description.type >-> Sortclass.
Notation fuel:= description.fuel.
Notation zero:= description.zero.

Section descriptions.
Context Q (A: description.type Q).
Notation fuel:= (fuel A).
Notation zero:= (zero A).
